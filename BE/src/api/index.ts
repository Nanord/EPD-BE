...
export { default as recipientscharges } from './methods/report/RecipientsCharges';
export { default as providerscharges } from './methods/report/ProvidersCharges';
export { default as providersacceptedpayments } from './methods/report/ProvidersAcceptedPayments'
