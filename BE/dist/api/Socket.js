...
var WS_1 = __importDefault(require("../utils/WS"));
var Logger_1 = __importDefault(require("../utils/Logger"));
var User_1 = __importDefault(require("../utils/User"));
var Socket = /** @class */ (function (_super) {
     ...
     * Отправить админам
     */
    Socket.prototype.sendToAdmin = function (data) {
        this.sendMessageByMatch(JSON.stringify(data), function (user) {
            return (user.login === "superuser" || user.roles.findIndex(function (role) { return role.name === "EPD_ADMIN"; }) >= 0);
        });
    };
    return Socket;
}(WS_1.default));
