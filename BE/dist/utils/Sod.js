...
var SOD = /** @class */ (function () {
    function SOD(endpoint, timeout) {
        this.endpoint = endpoint;
        this.timeout = timeout;
    }
    SOD.getInstance = function (endpoint, timeout) {
    ...
    SOD.prototype.query = function (name, org, params, out_params, needUnicode) {
        if (org === void 0) { org = -1; }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        json = JSON.stringify({ name: name, org: org, params: params, out_params: out_params });
                        if (needUnicode) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, res.data.contents];
                }
            });
        });
    };
