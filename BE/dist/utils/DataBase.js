 ...
 */
exports.default = (function (queryName, variables) { return __awaiter(_this, void 0, void 0, function () {
    var query, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                query = queryCache[queryName];
                if (!query) {
                    query = fs.readFileSync(path.resolve(__dirname, '..', '..', 'queries', queryName + ".gql"), 'utf8');
                    queryCache[queryName] = query;
                }
                return [4 /*yield*/, graphql_request_1.request(endpoint, query, variables)];
            case 1:
                result = _a.sent();
                if (Object.keys(result).length === 1) {
                    return [2 /*return*/, result[Object.keys(result)[0]]];
                }
